...
inputFileName = '1k_opened_correct_wcs_nocomma'
...
# Make param_hecho unique, note the map to integer on the second line
...
print "unique len: ", len(unique_pert_etnica), ", vs original len: ", len(list_pert_etnica)
...
for i in range(0,len(count_pert_etnica)):
	if i == 0:
		...
		currentRank_pert_etnica.append(count_param_hecho[i])
