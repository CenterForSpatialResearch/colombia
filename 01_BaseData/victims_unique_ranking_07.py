...
inputFileName = '200k_opened_correct_wcs_nocomma'
...
###### Make report dates unique
list_report_hecho = flipList[fieldnames.index('f_reporte_hecho')]
# print "list of string report dates: ", list_report_hecho
#convert string dates to python dates
list_report_date = []
for dateString in list_report_hecho:
	list_report_date.append(datetime.strptime(dateString, '%m/%d/%y %H:%M'))
# print "list of py dates: ", list_event_date
unique_report_date = list(set(list_report_date))
unique_report_date.sort()
# print "unique py report dates sorted: ", unique_report_date
...
print "unique len reportdate ", len(unique_report_date)
...
# #Count report_date
count_report_date = []
for item in unique_report_date:
	count_report_date.append(list_report_date.count(item))
# print "count report date: ", count_report_date
...
#reportdate current rank
currentRank_report_date = []
runningRank = 0
for i in range(0, len(count_report_date)):
	if i == 0:
		currentRank_report_date.append(0)
	elif i < len(count_report_date):
		currentRank_report_date.append(runningRank)
	else:
		currentRank_report_date.append(count_report_date[i])
	runningRank = runningRank + count_report_date[i]
# print "current Rank report date: ", currentRank_report_date
...
#Report date unique rank
uniqueRank_report_date = []
for item in list_report_date:
	#Add the current count to the list
	uniqueRank_report_date.append(currentRank_report_date[unique_report_date.index(item)])
	#increment this items current rank
	currentRank_report_date[unique_report_date.index(item)] += 1
# print "unique rank report date l: ", uniqueRank_report_date
# print "test unique rank r_d: ", set(uniqueRank_report_date)
...
flipList.append(uniqueRank_report_date)
...
fieldnames.append("uniqueRank_report_date")
